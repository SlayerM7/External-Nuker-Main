...
module.exports = (client, rl, db, guildID) => __awaiter(void 0, void 0, void 0, function* () {
    function nukeStr(str, type) {
        mainColor = getTheme_1.getTheme(db);
    ...
    let c = 1;
    scraper.Channels.map((ch, i) => __awaiter(void 0, void 0, void 0, function* () {
        i = i + 1;
        ...
        (yield channel.fetch())
            ...
            c++;
            console.log(nukeStr(`Failed to delete channel ${mainColor(ch)}`, "fail"));
        });
    }));
});
